...
public class AutoSaveService extends Service {
    ...
    public void upload(String no) {
        ...
        if (NetUtils.isNetworkConnected(this)) {
            requestmaker.StepCounterInsert(no,userid, StepDetector.CURRENT_SETP + "", timeCount, h1 + "." + h2, calories + "", getYesterday(), new JsonAsyncTask_Info(this, true, new JsonAsyncTaskOnComplete() {
                @Override
