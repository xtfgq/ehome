...
import com.zzu.ehome.activity.MyDoctorActivity;
...
import com.zzu.ehome.view.MoboView;
 ...
 */
public class MaiBoChartFragment extends BaseFragment implements View.OnClickListener,StickyListHeadersListView.OnHeaderClickListener {
    private View mView;
    ...
    private MaiboResChatAdapter mAadpter;
    ...
    public static Fragment getInstance() {
        return new MaiBoChartFragment();
    }

    public void initViews() {
        inflater = LayoutInflater.from(getActivity());
        mAadpter = new MaiboResChatAdapter(getActivity());
        layout_no_msg=(LinearLayout)mView.findViewById(R.id.layout_no_msg);
        heardchat = (LinearLayout) inflater.inflate(R.layout.new_maibo_layout, null);
                    ...
                    if (array.getJSONObject(0).has("MessageCode")) {
                        ...
                        if(array.length()>=6){
                            ...
                            for (i = list.size()-1,j=0; i>=0 ; i--,j++) {
                                ...
                                Double yd = Double.valueOf(list.get(i).getPulse());
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.rl_weight_time && pvTime != null) {
            ...
            getMaiboRecords(tvstart.getText().toString(),tvend.getText().toString());
        }
    ...
    private void getMaiboRecords(String starttime,String endtime){
