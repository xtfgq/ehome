...
import com.zzu.ehome.adapter.TCAdapter;
 ...
 */
public class TCFragment extends BaseFragment implements View.OnClickListener,StickyListHeadersListView.OnHeaderClickListener {
    private View mView;
    ...
    public void initViews() {
        ...
        mAadpter = new TCAdapter(getActivity());
        layout_no_msg=(LinearLayout)mView.findViewById(R.id.layout_no_msg);
        heardchat = (LinearLayout) inflater.inflate(R.layout.layout_tc, null);
    ...
    private void getTop(int num) {
        requestMaker.BiochemistryInquiryForLine(cardNo,"TC","","","7",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
    ...
    private void getPressRecords(String starttime,String endtime){
        ...
        try {
            ...
            if (dtend.getTime() >= dtStart.getTime()) {
                ...
                requestMaker.BiochemistryInquiryForLine(cardNo,"TC",starttime,endtime,"",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
                    public void processJsonObject(Object result) {
