...
import com.zzu.ehome.adapter.LowDensityAdapter;
 ...
 */
public class LowDensityProteinFragment extends BaseFragment implements View.OnClickListener,StickyListHeadersListView.OnHeaderClickListener {
    private View mView;
    ...
    private LowDensityAdapter mAadpter;
    ...
    public static Fragment getInstance() {
        return new LowDensityProteinFragment();
    }

    public void initViews() {
        inflater = LayoutInflater.from(getActivity());
        mAadpter = new LowDensityAdapter(getActivity());
        layout_no_msg=(LinearLayout)mView.findViewById(R.id.layout_no_msg);
        heardchat = (LinearLayout) inflater.inflate(R.layout.layout_low_density, null);
    ...
    private void getTop(int num) {
        ...
        requestMaker.BiochemistryInquiryForLine(cardNo,"LDL-C","","","7",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
    ...
    private void getPressRecords(String starttime,String endtime){
        ...
        try {
            ...
            if (dtend.getTime() >= dtStart.getTime()) {
                requestMaker.BiochemistryInquiryForLine(cardNo,"LDL-C",starttime,endtime,"",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
                    public void processJsonObject(Object result) {
