...
import com.zzu.ehome.adapter.HighDensityAdapter;
 ...
 */
public class HighDensityProteinFragment extends BaseFragment implements View.OnClickListener,StickyListHeadersListView.OnHeaderClickListener {
    private View mView;
    ...
    private HighDensityAdapter mAadpter;
    ...
    public static Fragment getInstance() {
        return new HighDensityProteinFragment();
    }

    public void initViews() {
        inflater = LayoutInflater.from(getActivity());
        mAadpter = new HighDensityAdapter(getActivity());
        layout_no_msg=(LinearLayout)mView.findViewById(R.id.layout_no_msg);
        heardchat = (LinearLayout) inflater.inflate(R.layout.layout_high_density, null);
        ...
        tv_title=(TextView)heardchat.findViewById(R.id.tv_title);
        tv_title.setText("高密度脂蛋白");
    ...
    private void getTop(int num) {
        ...
        requestMaker.BiochemistryInquiryForLine(cardNo,"HDL-C","","","7",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
                    public void processJsonObject(Object result) {
                        ...
                        try {
                            ...
                            if(array.getJSONObject(0).has("MessageCode")){
                                ...
                                UriAacidDate data = JsonTools.getData(result.toString(), UriAacidDate.class);
                                List<UricAcidBean> list = data.getData();
    ...
    private void getPressRecords(String starttime,String endtime){
        ...
        try {
            ...
            if (dtend.getTime() >= dtStart.getTime()) {
                requestMaker.BiochemistryInquiryForLine(cardNo,"HDL-C",starttime,endtime,"",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
                    public void processJsonObject(Object result) {
                        ...
                        try {
                            ...
                            if (array.getJSONObject(0).has("MessageCode")) {
                                ...
                                List<UricAcidBean> list = new ArrayList<UricAcidBean>();
                                mAadpter.setList(list);
                                labels.clear();
                                mChart.setX(labels,list.size());
                                List<PointD> linePoint1 = new ArrayList<PointD>();
