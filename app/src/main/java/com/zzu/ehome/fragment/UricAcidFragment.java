...
import com.zzu.ehome.adapter.UricAcidAdapter;
 ...
 */
public class UricAcidFragment extends BaseFragment implements View.OnClickListener,StickyListHeadersListView.OnHeaderClickListener {
    private View mView;
    ...
    private UricAcidAdapter mAadpter;
...
//        cardNo="410102198201251513";
    ...
    public static Fragment getInstance() {
        return new UricAcidFragment();
    }

    public void initViews() {
        inflater = LayoutInflater.from(getActivity());
        mAadpter = new UricAcidAdapter(getActivity());
        layout_no_msg=(LinearLayout)mView.findViewById(R.id.layout_no_msg);
        heardchat = (LinearLayout) inflater.inflate(R.layout.new_uricacid_layout, null);
    ...
    private void getTop(int num) {
        requestMaker.BiochemistryInquiryForLine(cardNo,"UA","","",num+"",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
    ...
    private void getPressRecords(String starttime,String endtime){
        ...
        try {
            ...
            if (dtend.getTime() >= dtStart.getTime()) {
                requestMaker.BiochemistryInquiryForLine(cardNo,"UA",starttime,endtime,"",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
                    public void processJsonObject(Object result) {
