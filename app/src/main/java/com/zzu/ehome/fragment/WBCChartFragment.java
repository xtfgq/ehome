 ...
 */
public class WBCChartFragment extends BaseFragment implements View.OnClickListener,StickyListHeadersListView.OnHeaderClickListener {
    private View mView;
...
//       cardNo="410223198012031258";
    ...
    public void initViews() {
        ...
        heardchat = (LinearLayout) inflater.inflate(R.layout.new_white_layout, null);
    ...
    private void getTop(int num) {
        requestMaker.BloodRoutineInquiryForLine(cardNo,  "", "",  num + "", "WBC",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
            @Override
    ...
    private void getRBCRecords(String starttime,String endtime){
        ...
        try {
            ...
            if (dtend.getTime() >= dtStart.getTime()) {
                requestMaker.BloodRoutineInquiryForLine(cardNo,starttime,endtime,"", "WBC",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete(){
                    @Override
                    public void processJsonObject(Object result) {
