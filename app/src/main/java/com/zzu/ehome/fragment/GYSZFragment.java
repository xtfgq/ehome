...
import com.zzu.ehome.adapter.GYSZAdapter;
 ...
 */
public class GYSZFragment extends BaseFragment implements View.OnClickListener,StickyListHeadersListView.OnHeaderClickListener {
    private View mView;
    ...
    public static Fragment getInstance() {
        return new GYSZFragment();
    }

    public void initViews() {
        inflater = LayoutInflater.from(getActivity());
        mAadpter = new GYSZAdapter(getActivity());
        layout_no_msg=(LinearLayout)mView.findViewById(R.id.layout_no_msg);
        heardchat = (LinearLayout) inflater.inflate(R.layout.layout_tg, null);
    ...
    private void getTop(int num) {
        requestMaker.BiochemistryInquiryForLine(cardNo,"TG","","",num+"",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
    ...
    private void getPressRecords(String starttime,String endtime){
        ...
        try {
            ...
            if (dtend.getTime() >= dtStart.getTime()) {
                ...
                requestMaker.BiochemistryInquiryForLine(cardNo,"TG",starttime,endtime,"",new JsonAsyncTask_Info(getActivity(), true, new JsonAsyncTaskOnComplete() {
                    @Override
                    public void processJsonObject(Object result) {
