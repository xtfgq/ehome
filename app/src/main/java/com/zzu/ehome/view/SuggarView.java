 ...
 */
public class SuggarView extends ChildView {
    ...
    SplineData dataSeries3;
    private Context mContext;


    public SuggarView(Context context) {
        super(context);
    ...
    public SuggarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initView();
    }

    public SuggarView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void refresh(List<PointD> linePoint1, List<PointD> linePoint2,List<PointD> linePoint3) {
        dataSeries1.setLineDataSet(linePoint1);
        dataSeries2.setLineDataSet(linePoint2);
        dataSeries3.setLineDataSet(linePoint3);
        this.invalidate();
    }
...
//定义数据轴标签显示格式
...

    {
        ...
        dataSeries1.getDotLabelPaint().setColor(Color.parseColor("#167ed1"));
...
//        #81c784
        ...
        dataSeries2.getDotLabelPaint().setColor(Color.parseColor("#81c784"));
...
//        dataSeries2.getLabelOptions().getBox().setRoundRadius(2);
        ...
        dataSeries3 = new SplineData("", null,
                Color.parseColor("#f9a116"));
        dataSeries3.setLabelVisible(false);
        dataSeries3.setDotStyle(XEnum.DotStyle.DOT);
        dataSeries3.setDotRadius(6);
        dataSeries3.getDotLabelPaint().setColor(Color.parseColor("#f9a116"));
        dataSeries3.setLabel(null);
        dataSeries3.getLabelOptions().getBox().getBackgroundPaint().setColor(Color.WHITE);
//        dataSeries2.getLabelOptions().getBox().setRoundRadius(2);
        dataSeries3.getLabelOptions().setLabelBoxStyle(XEnum.LabelBoxStyle.CAPROUNDRECT);
