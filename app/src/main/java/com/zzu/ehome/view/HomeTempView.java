 ...
 */
public class HomeTempView extends ChartView {
...
//    	private AreaChart chart = new AreaChart();
    ...
    public HomeTempView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initView();
    }

    public HomeTempView(Context context, AttributeSet attrs, int defStyle) {
