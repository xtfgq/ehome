...
public class RefreshLayout extends RelativeLayout {
    ...
    private AnimationDrawable mLoadAnim, mRefresh;
...
/*				pullUpView.clearAnimation();
    ...
    private void initView() {
        ...
        refreshingView.setBackgroundResource(R.drawable.loading_anim);
        mRefresh = (AnimationDrawable) refreshingView.getBackground();
        ...
        loadingView.setBackgroundResource(R.drawable.loading_anim);
        mLoadAnim = (AnimationDrawable) loadingView.getBackground();
