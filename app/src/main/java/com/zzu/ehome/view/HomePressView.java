 ...
 */
public class HomePressView extends ChartView {
    ...
    public HomePressView(Context context) {
        super(context);
    ...
    public HomePressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initView();
    }

    public HomePressView(Context context, AttributeSet attrs, int defStyle) {
...
//        chart.getPlotArea().extWidth(labels.size()*10f);
    ...
    private void chartRender() {
        try {
            ...
            int size = (18 * ScreenUtils.getScreenHeight(mContext)) / 1080;
