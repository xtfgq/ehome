 ...
 */
public class HomeSuggarView extends ChartView {
    ...
    public HomeSuggarView(Context context) {
        super(context);
    ...
    public HomeSuggarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initView();
    }

    public HomeSuggarView(Context context, AttributeSet attrs, int defStyle) {
