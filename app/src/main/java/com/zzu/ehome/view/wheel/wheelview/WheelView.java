...
package com.zzu.ehome.view.wheel.wheelview;

import java.util.LinkedList;
import java.util.List;

import com.zzu.ehome.R;
import com.zzu.ehome.view.wheel.wheelview.adapter.WheelViewAdapter;
...
//			0xcffffff, 0x3fffffff };
    private int[] SHADOWS_COLORS = new int[]{0x22000000,
            0x00fd4425, 0x00fd4425};
