...
import static com.zzu.ehome.R.id.ivhead;
...
public class PromotedActionsLibrary {
    ...
    public void setup(Context activityContext, FrameLayout layout,ImageView ivhead) {
        context = activityContext;
        promotedActions = new ArrayList<ImageView>();
        frameLayout = layout;
        px = (int) context.getResources().getDimension(R.dimen.dim36dp) + 10;
        this.ivhead=ivhead;
        openRotation();
        closeRotation();
    ...
    public ImageView addMainItem(String url) {
    ...
    public void addItem(String  url, View.OnClickListener onClickListener) {
