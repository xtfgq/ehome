 ...
 */
public class MoboView extends ChildView {
    ...
    public MoboView(Context context) {
        super(context);
    ...
    public MoboView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initView();
    }

    public MoboView(Context context, AttributeSet attrs, int defStyle) {
