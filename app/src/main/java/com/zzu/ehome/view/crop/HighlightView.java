...
package com.zzu.ehome.view.crop;
...
class HighlightView {
    ...
    protected final Paint outsidePaint = new Paint();
    protected final Paint outlinePaint = new Paint();
    ...
    protected HandleMode handleMode = HandleMode.Changing;
