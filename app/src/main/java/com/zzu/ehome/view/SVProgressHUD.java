...
public class SVProgressHUD {
    ...
    private static final long DISMISSDELAYED = 1200;
    ...
    public static final SVProgressHUD getInstance(Context context) {
    ...
    private void setMaskType(SVProgressHUDMaskType maskType) {
        ...
        switch (mSVProgressHUDMaskType) {
            ...
            case ClearCancel:
                ...
                break;
            case Black:
                configMaskType(R.color.dialog_black, true, false);
                break;
            case BlackCancel:
    ...
    private void configMaskType(int bg, boolean clickable, boolean cancelable) {
        rootView.setBackgroundResource(R.color.dialog_black);
