 ...
 */
public class UaView extends ChildView {
    ...
    public UaView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initView();
    }

    public UaView(Context context, AttributeSet attrs, int defStyle) {
...
//       chart.setCategories(labels);
    ...
    private void chartRender() {
        try {
            ...
            //坐标系
            //数据轴最大值
            chart.getDataAxis().setAxisMax(0.5);
    ...
    private void chartDataSet() {
        dataSeries2 = new SplineData("尿酸", null,
