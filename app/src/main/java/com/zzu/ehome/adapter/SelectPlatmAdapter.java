 ...
 */
public class SelectPlatmAdapter extends BaseListAdapter<TitleInquiryBean> {
    public int getIndex() {
        return index;
    }
    ...
    private int index=0;
    private List<TitleInquiryBean> list;

    public SelectPlatmAdapter(Context context, List<TitleInquiryBean> objects) {
