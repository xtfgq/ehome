 ...
 */
public class MaiboResChatAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public MaiboResChatAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int pulse=Integer.parseInt(res.getPulse());
