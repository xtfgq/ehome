 ...
 */
public class HighDensityAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public HighDensityAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String mb = "高密度脂蛋白: " +decimalFormat.format(n) +" mmol/L";
        SpannableString style1 = new SpannableString(mb);
        style1.setSpan(
                new TextAppearanceSpan(mContext, R.style.styleNormalColor), 7, mb.length()-6, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        holder.tv_ssy.setText(style1);
        if(Double.compare(n,0.8d)<0){
            holder.tv_status.setText("偏低");
            holder.rl_status.setBackgroundResource(R.drawable.btn_yuyue);

        }else if(Double.compare(n,1.6d)>0){
