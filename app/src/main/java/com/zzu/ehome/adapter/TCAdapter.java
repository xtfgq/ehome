 ...
 */
public class TCAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String mb = "总胆固醇: " +decimalFormat.format(n) +" mmol/L";
