...
public class TempChatAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    public List<TempRes> getList() {
        return list;
    }

    public void setList(List<TempRes> list) {
        this.list = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TempRes res = (TempRes) getItem(position);
        if (convertView == null) {
        ...
        float temp = Float.valueOf(res.getValue());
