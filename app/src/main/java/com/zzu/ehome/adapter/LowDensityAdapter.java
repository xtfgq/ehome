 ...
 */
public class LowDensityAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public LowDensityAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String mb = "低密度脂蛋白: " + decimalFormat.format(n)+" mmol/L";
