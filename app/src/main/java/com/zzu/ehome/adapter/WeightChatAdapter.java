...
public class WeightChatAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public List<WeightBeanRes> getList() {
        return list;
    }
    ...
    public void setList(List<WeightBeanRes> list) {
        this.list = list;
    }

    List<WeightBeanRes> list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        WeightBeanRes res = (WeightBeanRes) getItem(position);
        if (convertView == null) {
