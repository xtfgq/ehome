 ...
 */
public class UricAcidAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public UricAcidAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String mb = "尿酸: " +decimalFormat.format(n)+" umol/L";
        SpannableString style1 = new SpannableString(mb);
        style1.setSpan(
                new TextAppearanceSpan(mContext, R.style.styleNormalColor), 3, mb.length()-6, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        holder.tv_ssy.setText(style1);
        if(Double.compare(n,150)<0){
            holder.tv_status.setText("偏低");
            holder.rl_status.setBackgroundResource(R.drawable.btn_yuyue);

        }else if(Double.compare(n,420)>0){
