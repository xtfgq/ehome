 ...
 */
public class WeightResAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    private String userid;

    public List<WeightRes> getList() {
        return list;
    }
    ...
    public void setList(List<WeightRes> list) {
        this.list = list;
    }
    ...
    public WeightResAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        WeightRes res = (WeightRes) getItem(position);
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_curve_weight,
                    parent, false);
...
//            holder.tv_status=(TextView) convertView.findViewById(R.id.tv_tz_msg);
        ...
        String s = "体重:" + decimalFormat.format(Double.valueOf(res.getWeight()) )+ "kg";
...
//        if (!TextUtils.isEmpty(dbUser.getUserHeight())) {
            ...
            float bmi = Float.valueOf(res.getBMI());
