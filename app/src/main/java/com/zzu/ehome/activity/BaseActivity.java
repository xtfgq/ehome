 ...
 */
public class BaseActivity extends SupperBaseActivity {
...
//        DialogTips dialog = new DialogTips(this, "温馨提示", "是否退出软件？",
//                "确定", true, true);
...
//        PermissionGen.needPermission(BaseActivity.this, 100,
//                new String[] {
