 ...
 */
public class SmokeStateActivity extends NetBaseActivity {
    ...
    public void initEvent() {
        ...
        tv_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("smoke", list.get(index));
                setResult(BaseFilesActivity.SMOKE_STATE, intent);
                finish();
            }
        });
    }
