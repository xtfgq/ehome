...
/*
    ...
    private void getDate() {
         ...
         * 查询历史数据
         */
        requestmaker.StepCounterInquiry(cardNo,userid, "", 10 + "", page + "", new JsonAsyncTask_Info(this, true, new JsonAsyncTaskOnComplete() {
            @Override
    ...
    protected void onStop() {
        super.onStop();
        StepDetector.CURRENT_SETP=Integer.valueOf(circleBar.getMiddleText());
        upload();
    }
    ...
    public void upload() {
        ...
        if (NetUtils.isNetworkConnected(this)) {
            requestmaker.StepCounterInsert(cardNo,userid, StepDetector.CURRENT_SETP + "", timeCount, h1 + "." + h2, String.format("%.2f", calories), getTime(), new JsonAsyncTask_Info(this, true, new JsonAsyncTaskOnComplete() {
                @Override
                public void processJsonObject(Object result) {
                    try {
                        JSONObject mySO = (JSONObject) result;
