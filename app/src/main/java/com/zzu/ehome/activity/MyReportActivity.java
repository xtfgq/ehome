...
import com.zzu.ehome.fragment.MyECGReportFragmet;
import com.zzu.ehome.fragment.MyExaminationFragment;
...
public class MyReportActivity extends BaseActivity {
    ...
    public Fragment creatFragment(Type type) {
        ...
        switch (type) {
            ...
            case EXAMINATION:
                //请求数据地址
                fragment = MyExaminationFragment.getInstance();
                break;
            case ECG:
                //请求数据地址
                fragment = MyECGReportFragmet.getInstance();
                break;
        }
